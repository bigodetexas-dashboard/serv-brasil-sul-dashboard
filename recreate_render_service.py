...
response = requests.post(
    f"{BASE_URL}/services/{OLD_SERVICE_ID}/suspend",
    headers=headers
)
...
new_service = {
    ...
    "serviceDetails": {
        ...
        "region": "oregon",
        "envVars": [
            {"key": "SECRET_KEY", "value": "399a2d81b3710671c6ab9ff055fee0af8cf0c48f9c4fb789e52a5635d0119ec8"},
            {"key": "DATABASE_URL", "value": "postgresql://postgres:Lissy%402000@db.uvyhpedcgmroddvkngdl.supabase.co:5432/postgres"},
            {"key": "DISCORD_CLIENT_ID", "value": "1442959269141020892"},
            {"key": "DISCORD_CLIENT_SECRET", "value": "K7TpzNNTVI0Zj0zfpuwF_i-GLDu2S5c0"},
            {"key": "DISCORD_REDIRECT_URI", "value": "https://serv-brasil-sul-dashboard.onrender.com/callback"},
            {"key": "DISCORD_TOKEN", "value": "ODQ3NDU2NjUyMjUzMDY5Mzgy.GN2g88.GGCUohzjGJmtBpnNELLJJB6abbjSQx2rQAWyzg"},
            {"key": "ADMIN_PASSWORD", "value": "Lissy@2000"},
            {"key": "ADMIN_WHITELIST", "value": "831391383981522964"},
            {"key": "FOOTER_ICON", "value": "https://cdn.discordapp.com/attachments/1442262893188878496/1442286419539394682/logo_texas.png"},
            {"key": "FTP_HOST", "value": "brsp012.gamedata.io"},
            {"key": "FTP_PASS", "value": "hqPuAFd9"},
            {"key": "FTP_PORT", "value": "21"},
            {"key": "FTP_USER", "value": "ni3622181_1"},
            {"key": "NITRADO_TOKEN", "value": "FumKsv7MGrfa6zG0bxW7C3kqigM0zloo1FlQH3JqLeQ7siSoqw8DvLbAojdYqr_iheYUt-RYGcTC8rIHfoL662exac8yR8It21vS"},
            {"key": "NOTIFICATION_WEBHOOK_URL", "value": "https://discord.com/api/webhooks/1441892129591922782/20eO0Z6wurnlD47-BgQ7yP5ePt0mK-2pXF8iQUuLfllqkPyVGdkVuSdTr6vd5sBEWCz2"},
