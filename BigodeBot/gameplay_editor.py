...
EDITABLE_PARAMS = {
    "Buffs": {
        "HealthRegen": {
            ...
            "min": 0.1,
            "max": 10.0,
            "desc": "Regeneração de vida",
        },
        "BloodRegen": {
            "type": "float",
            "min": 0.1,
            "max": 10.0,
            "desc": "Regeneração de sangue",
        },
        "ShockRegen": {
            "type": "float",
            "min": 0.1,
            "max": 10.0,
            "desc": "Regeneração de shock",
        },
        "FoodConsumption": {
            "type": "float",
            "min": 0.1,
            "max": 5.0,
            "desc": "Consumo de comida",
        },
        "WaterConsumption": {
            "type": "float",
            "min": 0.1,
            "max": 5.0,
            "desc": "Consumo de água",
        },
        "ClothingDamageMultiplier": {
            "type": "float",
            "min": 0.0,
            "max": 5.0,
            "desc": "Dano em roupas",
        ...
        "SwimStaminaCost": {
            ...
            "min": 0.1,
            "max": 5.0,
            "desc": "Custo de stamina ao nadar",
        },
    },
    "GeneralData": {
        ...
        "disableContainerDamage": {
            "type": "bool",
            "desc": "Desabilitar dano em containers",
        },
        "disableRespawnDialog": {
            "type": "bool",
            "desc": "Desabilitar diálogo de respawn",
        },
        "disableRespawnInUnconsciousness": {
            "type": "bool",
            "desc": "Desabilitar respawn inconsciente",
        },
    },
    "BaseBuildingData.ConstructionDecayData": {
        "enableBaseDecay": {
            ...
            "min": 0,
            "max": 1,
            "desc": "Ativar decay de base (0/1)",
        },
        "decayTimeMinutes": {
            "type": "int",
            "min": 1,
            "max": 525600,
            "desc": "Tempo de decay (minutos)",
        },
        "refreshFlagDecayTimeMinutes": {
            "type": "int",
            "min": 1,
            "max": 525600,
            "desc": "Tempo refresh flag (minutos)",
        },
    },
        ...
        if param_type == "bool":
            if value_str.lower() in ["true", "1", "yes", "sim"]:
                ...
                return (
                    False,
                    None,
                    "Valor booleano inválido! Use: true/false, 1/0, yes/no",
                )
