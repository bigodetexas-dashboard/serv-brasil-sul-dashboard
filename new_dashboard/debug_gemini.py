...
# Carrega .env do diretório pai (BigodeBot)
load_dotenv(
...
async def test_gemini():
    ...
    print(f"API_KEY encontrada: {'Sim' if API_KEY else 'Não'}")
    ...
    try:
        ...
        # Teste síncrono primeiro para simplificar
        response = client.models.generate_content(
            model=MODEL_NAME,
            contents="Olá, você está funcionando? Responda com 'SISTEMA OPERACIONAL'.",
        )
