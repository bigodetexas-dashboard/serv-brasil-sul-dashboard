...
class SimulationClient(discord.Client):
    async def on_ready(self):
        ...
        embed_dup = discord.Embed(
            title="🚫 BANIMENTO AUTOMÁTICO", color=discord.Color.red()
        )
        ...
        embed_reward = discord.Embed(
            description="💸 **SALÁRIO RECEBIDO!**\n**SobreviventeFiel** jogou por 2h 30m e ganhou **2500 DZ Coins**.",
        ...
        embed_build = discord.Embed(
            title="🚫 BANIMENTO AUTOMÁTICO", color=discord.Color.dark_red()
        )
        ...
        embed_alarm = discord.Embed(
            title="🚨 ALARME DE BASE DISPARADO!", color=discord.Color.red()
        )
