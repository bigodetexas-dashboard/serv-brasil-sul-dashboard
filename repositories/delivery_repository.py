...
class DeliveryQueueRepository(BaseRepository):
    ...
    def add_to_queue(
        ...
        """
        query = """
            INSERT INTO delivery_queue (discord_id, gamertag, item_name, item_code, quantity, coordinates, purchase_id, priority, status, created_at)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'pending', datetime('now'))
        """
        # Note: Using INSERT instead of queue_delivery function if it doesn't support gamertag
