...
function populateForm(settings) {
    ...
    const bioTypeSelect = document.getElementById('bio_type');
    if (bioTypeSelect) bioTypeSelect.value = settings.bio_type || 'auto';

    const bioContentInput = document.getElementById('bio_content');
    if (bioContentInput) bioContentInput.value = settings.bio_content || '';
...
function getFormData() {
    ...
    const bioTypeSelect = document.getElementById('bio_type');
    if (bioTypeSelect) data.bio_type = bioTypeSelect.value;

    const bioContentInput = document.getElementById('bio_content');
    if (bioContentInput) data.bio_content = bioContentInput.value;

    const bannerInput = document.getElementById('banner_url');
    if (bannerInput) data.banner_url = bannerInput.value;
