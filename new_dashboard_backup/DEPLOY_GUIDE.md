...
1. O banco de dados agora é **SQLite** (`bigode_unified.db`). Certifique-se de que ele está comitado ou use um **Persistent Disk** (Volume) se estiver no Render para não perder os dados.
...
| `DISCORD_REDIRECT_URI` | `https://seu-app.onrender.com/callback` (Ajuste conforme sua URL) |
